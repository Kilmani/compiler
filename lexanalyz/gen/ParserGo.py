...
class ParserGo ( Parser ):
    ...
    def packageClause(self):
        ...
        localctx = ParserGo.PackageClauseContext(self, self._ctx, self.state)
        self.enterRule(localctx, 2, self.RULE_packageClause)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 220
            self.match(ParserGo.PACKAGE)
            self.state = 221
    ...
    def importDecl(self):
        ...
        try:
            ...
            if token in [ParserGo.IDENTIFIER, ParserGo.DOT, ParserGo.RAW_STRING_LIT, ParserGo.INTERPRETED_STRING_LIT]:
                ...
                self.importSpec()
                pass
            elif token in [ParserGo.L_PAREN]:
                self.state = 225
    ...
    def importPath(self):
        ...
        localctx = ParserGo.ImportPathContext(self, self._ctx, self.state)
    ...
    def declaration(self):
        ...
        localctx = ParserGo.DeclarationContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [ParserGo.CONST]:
                ...
                self.constDecl()
                pass
            elif token in [ParserGo.TYPE]:
                self.enterOuterAlt(localctx, 2)
                self.state = 245
                self.typeDecl()
                pass
            elif token in [ParserGo.VAR]:
    ...
    class IdentifierListContext(ParserRuleContext):
        ...
        def COMMA(self, i:int=None):
            if i is None:
                ...
                return self.getToken(ParserGo.COMMA, i)
    ...
    def identifierList(self):
        ...
        localctx = ParserGo.IdentifierListContext(self, self._ctx, self.state)
    ...
    def expressionList(self):
        ...
        localctx = ParserGo.ExpressionListContext(self, self._ctx, self.state)
    ...
    def functionDecl(self):
        ...
        localctx = ParserGo.FunctionDeclContext(self, self._ctx, self.state)
        self.enterRule(localctx, 24, self.RULE_functionDecl)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 307
            self.match(ParserGo.FUNC)
            self.state = 308
            self.match(ParserGo.IDENTIFIER)
    ...
    def methodDecl(self):
        ...
        localctx = ParserGo.MethodDeclContext(self, self._ctx, self.state)
    ...
    def receiver(self):
        ...
        localctx = ParserGo.ReceiverContext(self, self._ctx, self.state)
    ...
    def varSpec(self):
        ...
        localctx = ParserGo.VarSpecContext(self, self._ctx, self.state)
    ...
    def statement(self):
        ...
        localctx = ParserGo.StatementContext(self, self._ctx, self.state)
    ...
    def simpleStmt(self):
        ...
        localctx = ParserGo.SimpleStmtContext(self, self._ctx, self.state)
    ...
    def expressionStmt(self):
        ...
        localctx = ParserGo.ExpressionStmtContext(self, self._ctx, self.state)
    ...
    def sendStmt(self):
        ...
        localctx = ParserGo.SendStmtContext(self, self._ctx, self.state)
    ...
    class IncDecStmtContext(ParserRuleContext):
        ...
        def MINUS_MINUS(self):
            return self.getToken(ParserGo.MINUS_MINUS, 0)
    ...
    def assignment(self):
        ...
        localctx = ParserGo.AssignmentContext(self, self._ctx, self.state)
    ...
    class Assign_opContext(ParserRuleContext):
        ...
        def MINUS(self):
            return self.getToken(ParserGo.MINUS, 0)

        def OR(self):
            return self.getToken(ParserGo.OR, 0)

        def CARET(self):
            return self.getToken(ParserGo.CARET, 0)

        def STAR(self):
            return self.getToken(ParserGo.STAR, 0)

        def DIV(self):
            return self.getToken(ParserGo.DIV, 0)

        def MOD(self):
            return self.getToken(ParserGo.MOD, 0)

        def LSHIFT(self):
            return self.getToken(ParserGo.LSHIFT, 0)

        def RSHIFT(self):
            return self.getToken(ParserGo.RSHIFT, 0)

        def AMPERSAND(self):
            return self.getToken(ParserGo.AMPERSAND, 0)

        def BIT_CLEAR(self):
            return self.getToken(ParserGo.BIT_CLEAR, 0)
    ...
    def shortVarDecl(self):
        ...
        localctx = ParserGo.ShortVarDeclContext(self, self._ctx, self.state)
    ...
    def emptyStmt(self):
        ...
        localctx = ParserGo.EmptyStmtContext(self, self._ctx, self.state)
    ...
    def labeledStmt(self):
        ...
        localctx = ParserGo.LabeledStmtContext(self, self._ctx, self.state)
    ...
    def returnStmt(self):
        ...
        localctx = ParserGo.ReturnStmtContext(self, self._ctx, self.state)
    ...
    class BreakStmtContext(ParserRuleContext):
        ...
        def BREAK(self):
            return self.getToken(ParserGo.BREAK, 0)
    ...
    def breakStmt(self):
        ...
        localctx = ParserGo.BreakStmtContext(self, self._ctx, self.state)
    ...
    class ContinueStmtContext(ParserRuleContext):
        ...
        def CONTINUE(self):
            return self.getToken(ParserGo.CONTINUE, 0)
    ...
    def continueStmt(self):
        ...
        localctx = ParserGo.ContinueStmtContext(self, self._ctx, self.state)
    ...
    class GotoStmtContext(ParserRuleContext):
        ...
        def GOTO(self):
            return self.getToken(ParserGo.GOTO, 0)
    ...
    def gotoStmt(self):
        ...
        localctx = ParserGo.GotoStmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 64, self.RULE_gotoStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 424
            self.match(ParserGo.GOTO)
            self.state = 425
            self.match(ParserGo.IDENTIFIER)
        except RecognitionException as re:
            localctx.exception = re
    ...
    class FallthroughStmtContext(ParserRuleContext):
        ...
        def FALLTHROUGH(self):
            return self.getToken(ParserGo.FALLTHROUGH, 0)
    ...
    def fallthroughStmt(self):
        ...
        localctx = ParserGo.FallthroughStmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 66, self.RULE_fallthroughStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 427
            self.match(ParserGo.FALLTHROUGH)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    def deferStmt(self):
        ...
        localctx = ParserGo.DeferStmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 68, self.RULE_deferStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 429
            self.match(ParserGo.DEFER)
            self.state = 430
            self.expression(0)
        except RecognitionException as re:
            localctx.exception = re
    ...
    def ifStmt(self):
        ...
        localctx = ParserGo.IfStmtContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                if token in [ParserGo.IF]:
                    ...
                    self.ifStmt()
                    pass
                elif token in [ParserGo.L_CURLY]:
                    self.state = 442
                    self.block()
                    pass
                else:
    ...
    def switchStmt(self):
        ...
        localctx = ParserGo.SwitchStmtContext(self, self._ctx, self.state)
    ...
    def exprSwitchCase(self):
        ...
        localctx = ParserGo.ExprSwitchCaseContext(self, self._ctx, self.state)
    ...
    def typeSwitchGuard(self):
        ...
        localctx = ParserGo.TypeSwitchGuardContext(self, self._ctx, self.state)
    ...
    def typeSwitchCase(self):
        ...
        localctx = ParserGo.TypeSwitchCaseContext(self, self._ctx, self.state)
    ...
    def typeList(self):
        ...
        try:
            ...
            if token in [ParserGo.FUNC, ParserGo.INTERFACE, ParserGo.MAP, ParserGo.STRUCT, ParserGo.CHAN, ParserGo.IDENTIFIER, ParserGo.L_PAREN, ParserGo.L_BRACKET, ParserGo.STAR, ParserGo.RECEIVE]:
                ...
                self.type_()
                pass
            elif token in [ParserGo.NIL_LIT]:
                self.state = 516
                self.match(ParserGo.NIL_LIT)
                pass
            else:
                raise NoViableAltException(self)
    ...
    class SelectStmtContext(ParserRuleContext):
        ...
        def SELECT(self):
            return self.getToken(ParserGo.SELECT, 0)
    ...
    def commCase(self):
        ...
        localctx = ParserGo.CommCaseContext(self, self._ctx, self.state)
    ...
    def recvStmt(self):
        ...
        localctx = ParserGo.RecvStmtContext(self, self._ctx, self.state)
    ...
    def forStmt(self):
        ...
        localctx = ParserGo.ForStmtContext(self, self._ctx, self.state)
    ...
    def rangeClause(self):
        ...
        localctx = ParserGo.RangeClauseContext(self, self._ctx, self.state)
    ...
    def goStmt(self):
        ...
        localctx = ParserGo.GoStmtContext(self, self._ctx, self.state)
        self.enterRule(localctx, 104, self.RULE_goStmt)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 592
            self.match(ParserGo.GO)
            self.state = 593
            self.expression(0)
        except RecognitionException as re:
            localctx.exception = re
    ...
    def type_(self):
        ...
        localctx = ParserGo.Type_Context(self, self._ctx, self.state)
    ...
    def typeName(self):
        ...
        localctx = ParserGo.TypeNameContext(self, self._ctx, self.state)
    ...
    def typeLit(self):
        ...
        localctx = ParserGo.TypeLitContext(self, self._ctx, self.state)
    ...
    def arrayType(self):
        ...
        localctx = ParserGo.ArrayTypeContext(self, self._ctx, self.state)
    ...
    def arrayLength(self):
        ...
        localctx = ParserGo.ArrayLengthContext(self, self._ctx, self.state)
    ...
    def elementType(self):
        ...
        localctx = ParserGo.ElementTypeContext(self, self._ctx, self.state)
    ...
    def pointerType(self):
        ...
        localctx = ParserGo.PointerTypeContext(self, self._ctx, self.state)
    ...
    class InterfaceTypeContext(ParserRuleContext):
        ...
        def INTERFACE(self):
            return self.getToken(ParserGo.INTERFACE, 0)
    ...
    def interfaceType(self):
        ...
        localctx = ParserGo.InterfaceTypeContext(self, self._ctx, self.state)
        self.enterRule(localctx, 120, self.RULE_interfaceType)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 629
            self.match(ParserGo.INTERFACE)
            self.state = 630
            self.match(ParserGo.L_CURLY)
            self.state = 636
            self._errHandler.sync(self)
    ...
    class MapTypeContext(ParserRuleContext):
        ...
        def MAP(self):
            return self.getToken(ParserGo.MAP, 0)
    ...
    def mapType(self):
        ...
        localctx = ParserGo.MapTypeContext(self, self._ctx, self.state)
        self.enterRule(localctx, 124, self.RULE_mapType)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 645
            self.match(ParserGo.MAP)
            self.state = 646
            self.match(ParserGo.L_BRACKET)
            self.state = 647
            self.type_()
    ...
    def channelType(self):
        ...
        localctx = ParserGo.ChannelTypeContext(self, self._ctx, self.state)
    ...
    def methodSpec(self):
        ...
        localctx = ParserGo.MethodSpecContext(self, self._ctx, self.state)
    ...
    def functionType(self):
        ...
        localctx = ParserGo.FunctionTypeContext(self, self._ctx, self.state)
    ...
    def signature(self):
        ...
        localctx = ParserGo.SignatureContext(self, self._ctx, self.state)
    ...
    def result(self):
        ...
        localctx = ParserGo.ResultContext(self, self._ctx, self.state)
    ...
    class ExpressionContext(ParserRuleContext):
        ...
        def EQUALS(self):
            return self.getToken(ParserGo.EQUALS, 0)

        def NOT_EQUALS(self):
            return self.getToken(ParserGo.NOT_EQUALS, 0)

        def LESS(self):
            return self.getToken(ParserGo.LESS, 0)

        def LESS_OR_EQUALS(self):
            return self.getToken(ParserGo.LESS_OR_EQUALS, 0)

        def GREATER(self):
            return self.getToken(ParserGo.GREATER, 0)

        def GREATER_OR_EQUALS(self):
            return self.getToken(ParserGo.GREATER_OR_EQUALS, 0)

        def LOGICAL_AND(self):
            return self.getToken(ParserGo.LOGICAL_AND, 0)

        def LOGICAL_OR(self):
            return self.getToken(ParserGo.LOGICAL_OR, 0)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 723
                        self.match(ParserGo.LOGICAL_AND)
                        self.state = 724
                        self.expression(3)
                        pass
                        ...
                        self.state = 726
                        self.match(ParserGo.LOGICAL_OR)
                        self.state = 727
                        self.expression(2)
                        pass
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = ParserGo.PrimaryExprContext(self, _parentctx, _parentState)
    ...
    class UnaryExprContext(ParserRuleContext):
        ...
        def EXCLAMATION(self):
            return self.getToken(ParserGo.EXCLAMATION, 0)
    ...
    def operand(self):
        ...
        localctx = ParserGo.OperandContext(self, self._ctx, self.state)
    ...
    def literal(self):
        ...
        localctx = ParserGo.LiteralContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [ParserGo.NIL_LIT, ParserGo.DECIMAL_LIT, ParserGo.OCTAL_LIT, ParserGo.HEX_LIT, ParserGo.FLOAT_LIT, ParserGo.IMAGINARY_LIT, ParserGo.RUNE_LIT, ParserGo.RAW_STRING_LIT, ParserGo.INTERPRETED_STRING_LIT]:
                ...
                self.basicLit()
                pass
            elif token in [ParserGo.MAP, ParserGo.STRUCT, ParserGo.IDENTIFIER, ParserGo.L_BRACKET]:
                self.enterOuterAlt(localctx, 2)
                self.state = 775
                self.compositeLit()
                pass
            elif token in [ParserGo.FUNC]:
                self.enterOuterAlt(localctx, 3)
                self.state = 776
                self.functionLit()
                pass
    ...
    class BasicLitContext(ParserRuleContext):
        ...
        def IMAGINARY_LIT(self):
            return self.getToken(ParserGo.IMAGINARY_LIT, 0)

        def RUNE_LIT(self):
            return self.getToken(ParserGo.RUNE_LIT, 0)
    ...
    def basicLit(self):
        ...
        localctx = ParserGo.BasicLitContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.enterOuterAlt(localctx, 4)
                self.state = 782
                self.match(ParserGo.FLOAT_LIT)
                pass

            elif la_ == 5:
                self.enterOuterAlt(localctx, 5)
                self.state = 783
                self.match(ParserGo.IMAGINARY_LIT)
                pass

            elif la_ == 6:
                self.enterOuterAlt(localctx, 6)
                self.state = 784
                self.match(ParserGo.RUNE_LIT)
                pass
    ...
    class IntegerContext(ParserRuleContext):
        ...
        def DECIMAL_LIT(self):
            return self.getToken(ParserGo.DECIMAL_LIT, 0)

        def OCTAL_LIT(self):
            return self.getToken(ParserGo.OCTAL_LIT, 0)

        def HEX_LIT(self):
            return self.getToken(ParserGo.HEX_LIT, 0)
    ...
    def operandName(self):
        ...
        localctx = ParserGo.OperandNameContext(self, self._ctx, self.state)
    ...
    def qualifiedIdent(self):
        ...
        localctx = ParserGo.QualifiedIdentContext(self, self._ctx, self.state)
    ...
    def compositeLit(self):
        ...
        localctx = ParserGo.CompositeLitContext(self, self._ctx, self.state)
    ...
    def literalType(self):
        ...
        localctx = ParserGo.LiteralTypeContext(self, self._ctx, self.state)
    ...
    def elementList(self):
        ...
        localctx = ParserGo.ElementListContext(self, self._ctx, self.state)
    ...
    def keyedElement(self):
        ...
        localctx = ParserGo.KeyedElementContext(self, self._ctx, self.state)
    ...
    def key(self):
        ...
        localctx = ParserGo.KeyContext(self, self._ctx, self.state)
    ...
    def element(self):
        ...
        localctx = ParserGo.ElementContext(self, self._ctx, self.state)
    ...
    class StructTypeContext(ParserRuleContext):
        ...
        def STRUCT(self):
            return self.getToken(ParserGo.STRUCT, 0)
    ...
    def structType(self):
        ...
        localctx = ParserGo.StructTypeContext(self, self._ctx, self.state)
        self.enterRule(localctx, 174, self.RULE_structType)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 844
            self.match(ParserGo.STRUCT)
            self.state = 845
            self.match(ParserGo.L_CURLY)
            self.state = 851
            self._errHandler.sync(self)
    ...
    def fieldDecl(self):
        ...
        localctx = ParserGo.FieldDeclContext(self, self._ctx, self.state)
    ...
    class String_Context(ParserRuleContext):
        ...
        def RAW_STRING_LIT(self):
            return self.getToken(ParserGo.RAW_STRING_LIT, 0)

        def INTERPRETED_STRING_LIT(self):
            return self.getToken(ParserGo.INTERPRETED_STRING_LIT, 0)
    ...
    def functionLit(self):
        ...
        localctx = ParserGo.FunctionLitContext(self, self._ctx, self.state)
    ...
    def index(self):
        ...
        localctx = ParserGo.IndexContext(self, self._ctx, self.state)
    ...
    def typeAssertion(self):
        ...
        localctx = ParserGo.TypeAssertionContext(self, self._ctx, self.state)
    ...
    def methodExpr(self):
        ...
        localctx = ParserGo.MethodExprContext(self, self._ctx, self.state)
    ...
    def receiverType(self):
        ...
        localctx = ParserGo.ReceiverTypeContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [ParserGo.IDENTIFIER]:
                ...
                if token in [ParserGo.STAR]:
                    ...
                    self.typeName()
                    pass
                elif token in [ParserGo.IDENTIFIER, ParserGo.L_PAREN]:
                    self.state = 933
                    self.receiverType()
                    pass
                else:
    ...
    class EosContext(ParserRuleContext):
        ...
        def EOF(self):
            return self.getToken(ParserGo.EOF, 0)
    ...
    def eos(self):
        ...
        localctx = ParserGo.EosContext(self, self._ctx, self.state)
